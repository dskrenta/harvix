...
print"<b>Web Results:</b><div class=\"bar\"><b>Sort by: Relevance &middot; <a href=\"http://harvix.com/harvix1.cgi?q=$query /date\">Date</a> &middot; <a href=\"http://harvix.com/harvix1.cgi?q=$query /news\">News</a></b></div><p>&nbsp;\n";

foreach my $res ( @results )
{
        print "<b><a href=", '"', $res->{url}, '">', $res->{title}, "</a></b><br>\n";
...
div.h7{width:100%; padding:0px; border:0px solid:black; margin:0px; background-color:black;}
div.1footer{color:gray;}
div.bar{float:right;}
div.footer{clear:both;text-align:center;}
div.large4{font-size:60px;}
...
div.h0{width:; padding:8px; border:0px solid:black; margin:0px; background-color:black;}
...
<td>
<div class="large4">
<b><span style="color:white;">Har</span><span style=color:red;">vix</span></b>
</div>
</td>
<td>
<form id="searchForm" name="searchForm" action="http://harvix.com/harvix1.cgi" onsubmit="submitted('h'); return false">
...
<table width="100%" cellpadding="10" cellspacing="0" border="1px">
<tr VALIGN=TOP>
EOF
;
...
<div class="bar">
<div class="h0">
<div class="fb-like" data-href="http://harvix.com/harvix1.cgi?q=$query" data-send="false" data-layout="button_count" data-width="200" data-show-faces="false" data-action="like" data-colorscheme="light"></div>
<p>
<div class="fb-comments" data-href="http://harvix.com/harvix1.cgi?q=$query" data-num-posts="50" data-width="200"></div>
</div>
</div>
</td>
</tr>
</table>
<center>coppyright</center>
</body> 
<html> 
EOX
;
