...
<script>(function(d, s, id) {
  ...
  <input type="text" style="width:650px;" action="http://harvix.com/harvixreturn.cgi" onsubmit="submitted('h'); return false" name="q"  class="search-query" placeholder="Showing results for $query">
