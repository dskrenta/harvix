...
# print categories 
	...
	{
		print"<iframe src=\"http://harvix.com/images2.cgi?$query\" width=\"100%\" height=\"400px\" frameborder=\"0\"></iframe>";
		print"<p>";
		print"<iframe src=\"http://harvix.com/videos2.cgi?$query\" width=\"100%\" height=\"400px\" frameborder=\"0\"></iframe>";
	}
...
# print results inside categories 
	...
	print"<iframe src=\"http://harvix.com/peoplequotes.cgi?$query\" width=\"100%\" height=\"350px\" frameborder=\"0\"></iframe>";
	...
	foreach my $result ( @{ $results } )
        {
                ...
                print"$snippet";
                print"<p><span style=\"color:green\">$rurl</span>";
                print"<form action=\"http://harvix.com/expand2.cgi\"><input type=\"hidden\" name=\"u\" value=\"$url\"/><button type=\"submit\" class=\"btn btn-small\">Expand</button></form>";
		print"</div></div>";
                #print"<hr></hr><p>";
                #print Dumper($result);
        }
