...
div.h7{width:100%; position: fixed; padding:8px; border:0px solid:black; margin:0px; background-color:black;}
div.1footer{color:gray;}
div.bar{float:right;}
div.footer{clear:both;text-align:center;}
div.large{font-size:60px; font-family:  Chalkduster, sans-serif; font-size: normal; line-height: normal;}
