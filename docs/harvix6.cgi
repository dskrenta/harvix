...
#START OF SEARCH RRR	
print"<td width=\"1000px\">";


foreach my $res ( @results )
{
       	
	print"<table cellspacing=\"10\"><tr><td valign=\"top\"><div class=\"fb-like\" data-href=\"$res->{url}\" data-send=\"true\" data-layout=\"box_count\" data-width=\"100\" data-show-faces=\"false\"></div></td>";
	print "<td valgin=\"top\"><div class=\"large4\"><b><u><a href=", '"', $res->{url}, '">', $res->{title}, "</a></u></b><br></div>\n";
...
div.side{width:100px; padding:8px; border:0px solid:black; margin:0px; background-color:white;}
...
<td>
<form id="searchForm" name="searchForm" action="http://harvix.com/harvix6.cgi" onsubmit="submitted('h'); return false">
