...
# print results inside categories 
	...
	foreach my $result ( @{ $results } )
		...
		if ($count == 3)
		{
			print"<a href=\"http://www.amazon.com/gp/search?ie=UTF8&camp=1789&creative=9325&index=aps&keywords=$query&linkCode=ur2&tag=harvix02-20\"><span style=\"color:#195189;\"><h4>Amazon.com: $query</h4></span></a>";
                        print"Online shopping for $query from the earth's biggest selection of books, magazines, music, DVDs, videos, electronics, computers, software, apparel, accessories, shoes, jewelry, tools &amp; hardware, housewares, furniture, sporting goods, beauty, personal care, gourmet food, just about anything else.";
                        print"<p><span style=\"color:green\">amazon.com</span>";
		}
	...
	print"<iframe src=\"http://harvix.com/facts3.cgi?$query\" width=\"100%\" height=\"350px\" frameborder=\"0\"></iframe>";
...
<script>
    //doesn't block the load event
        function createIframe(){
                ...
                var a = Math.random() + "";
                var t = a * 10000000000000;
                i.src = "http://harvix.com/videos2.cgi?$query";
                i.scrolling = "auto";
                i.frameborder = "0";
                i.width = "100%";
                i.height = "400px";
                i.style = "border: none";
                document.getElementById("frame2").appendChild(i);
        };
...
<script>
    //doesn't block the load event
        function createIframe(){
                ...
                var a = Math.random() + "";
                var t = a * 10000000000000;
                i.src = "http://harvix.com/peoplequotes.cgi?$query";
                i.scrolling = "auto";
                i.frameborder = "0";
                i.width = "100%";
                i.height = "350px";
                i.style = "border: none";
                document.getElementById("frame3").appendChild(i);
        };
