...
function blogposts() { // only use if span is at the end of the row 
	...
	$("#blogfour").click(function(){
                $(".blog-post-item.four").toggleClass("reveal");
        });
	$("#blogfive").click(function(){
                $(".blog-post-item.five").toggleClass("reveal");
        });  
	$("#blogsix").click(function(){
                $(".blog-post-item.six").toggleClass("reveal");
        });
	$("#blogseven").click(function(){
                $(".blog-post-item.seven").toggleClass("reveal");
        });
	$("#blogeight").click(function(){
                $(".blog-post-item.eight").toggleClass("reveal");
        });
	$("#blognine").click(function(){
                $(".blog-post-item.nine").toggleClass("reveal");
        });
	$("#blogten").click(function(){
                $(".blog-post-item.ten").toggleClass("reveal");
        });
	$("#blogeleven").click(function(){
                $(".blog-post-item.eleven").toggleClass("reveal");
        });
	$("#blogtwelve").click(function(){
                $(".blog-post-item.twelve").toggleClass("reveal");
        });
	$("#blogthirteen").click(function(){
                $(".blog-post-item.thirteen").toggleClass("reveal");
        });
}
