...
if(isset($_REQUEST['terms']) && !empty($_REQUEST['terms'])){ 
     ...
     $terms = urlencode('jobs'); /// you may uncomment this line and comment the line below to display results when users first land your page
...
function format_result($result){ 
	...
	if ($i = 0)	
	{
		echo"<iframe src=\"$redirect[1][$i]\"></iframe>";
	}
     }// end for 
