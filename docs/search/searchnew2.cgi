...
<script type="text/javascript">
  ...
  <div id='nav-bar-top'>
  <h1>Harvix</h1>
  <form id="searchForm" class="form-wrapper cf" onsubmit="submitted('h'); return false" action="http://harvix.com/search/searchnew.cgi" name="searchForm">
    <input id="searchBox" class="ac_input" type="text" onwebkitspeechchange="this.form.submit();" speech="" x-webkit-speech="" required="" name="q" spellcheck="false" autocomplete="off" autofocus="autofocus"></input>
