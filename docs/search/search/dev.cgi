					...
					<li>
          				...
          				<div class="timeline-panel">
            				...
            				<p><small class="text-muted"><i class="glyphicon glyphicon-ok"></i> $rurl</small></p>
                                        ...
                                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myWIKIModal"><i class="glyphicon glyphicon-fullscreen"></i></button>
					...
					my $imagehtml = qq{
						<li class="timeline-inverted">
          					...
          					<div class="timeline-panel">
            					...
            					<div class="timeline-body">
						<p>
						<img src="$url" width="100%"  alt="$url"></img>
						</p>
						<!--Like Dislike Flag-->
                                                <p>
                                                <div class="btn-group">
