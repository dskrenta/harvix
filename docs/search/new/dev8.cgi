				...
				{	
					my $ORIGModalhtml = qq{
						...
						<p><small class="text-muted"><i class="glyphicon glyphicon-ok"></i> $rurl</small></p>
                                                ...
                                                <p>
                                                <div class="btn-group">
						<a href="http://harvix.com/search/new/notes" target="_blank" class="btn btn-default"><i class="glyphicon glyphicon-pencil"></i></a>
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Harvix | battle of gettysburg</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Harvix Search Results for: battle of gettysburg">
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <form class="navbar-form">
            <input type="text" class="form-control" action="http://harvix.com/search/new/dev7.cgi" onsubmit="submitted('h'); return false" name="q"  class="search-query" value="battle of gettysburg">
