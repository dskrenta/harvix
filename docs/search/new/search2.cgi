		...
		my $img_count = 0;
			...
			if ($img_count == 0)
			{
				...
				my $imagehtml = qq{
					...
					<div class="widget-body">
						<div class="media">
						<div class="media-object pull-left thumb"><img src="" alt="Image" /></div>
						<div class="media-body">
						<a class="author">Adrian Demian</a><br/>
						<span class="muted">adrianennovation.ie</span>
						</div>
						</div>
					</div>
					</div>
			...
			if ($rescount == 1)
			{
				...
				my $cathtml = qq{
					<!--CAT Result Start-->
                                        <li class="active">
                                        <div class="separator bottom">
                                        <span class="type glyphicons suitcase">$category <i></i></span>
                                        </div>
                                        <div class="widget widget-heading-simple widget-body-white margin-none">
                                        <div class="widget-body">
                                        	<h3>$title</h1>
...
<body class="">
    ...
    <ul class="nav navbar-nav navbar-left">
        <li class=" hidden-xs">
            <form class="navbar-form navbar-left" action="http://harvix.com/search/new/search2.cgi" role="search">
