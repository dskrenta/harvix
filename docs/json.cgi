...
foreach my $tag ( @{ $json->{tags} } )
{
	...
	my $num = scalar @{ $results };
        ...
        {
        print "<div id=\"count\"><span class=\"label label-inverse\"><h4>Take Notes</h4></span></div> <div id=\"upper\"><span class=\"label label-success\"><h4>Instant Information:</h4></span></div><hr></hr>";
	}
	...
	print "<div id=\"count\"><span class=\"label\"><h4>HERE!</h4></span></div> <div id=\"upper\"><span class=\"label label-info\"><h4>Facts:</h4></span></div><hr></hr>";
