...
print"<div class=\"large\"><b>Videos:</b></div><p>\n";
...
print"</td></tr><tr><td>";
    ...
    while (my $image = $result->next()) {
        ...
        print("    <A HREF=\"$url\"><IMG WIDTH=\"\" HEIGHT=\"200\"SRC=\"$url\" ALT=\"$url\"/></A>\n");
        }
~                                                                                                          
...
<td>
<form id="searchForm" name="searchForm" action="http://harvix.com/harvix7.cgi" onsubmit="submitted('h'); return false">
...
<tr VALIGN=TOP>
<td>
<div class="fb-like" data-href="http://harvix.com/harvix7.cgi?q=$query" data-send="false" data-layout="button_count" data-width="200" data-show-faces="false" data-action="like" data-colorscheme="light"></div>
<p>
<div class="fb-send" data-href="http://harvix.com/harvix7.cgi?q=$query"></div>
</td>
<td>
<p>
<div class="fb-comments" data-href="http://harvix.com/harvix7.cgi?q=$query" data-num-posts="50" data-width="500"></div>
</td>
<td>
<p>
<p>
