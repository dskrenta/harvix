...
if( $query eq "timewaster" )
{
print "
<div class=\"large\"><b>Timewaster!</b></div>
<p>
<script type=\"text/javascript\" src=\"http://cdn.widgetserver.com/syndication/subscriber/InsertWidget.js\"></script><script type=\"text/javascript\">if (WIDGETBOX) WIDGETBOX.renderWidget(\'7bc5ac41-54c8-49ee-beeb-0415b7a9a27e\');</script>
...
if ( $wiki )
        {
            my ( $wiki_best, $wiki_rank, $wiki_fnam, $wiki_title, $wiki_page, $wiki_image, $wiki_url ) = @$wiki;
                ...
                print"<div class=\"hwiki\">";
                print "<div class=\"large4\"><a href=", '"', $wiki_url, '"><b>', $wiki_title, "</b></a><br></div>\n";
                print "<a href=\"$wiki_image\"><img src=\"$wiki_image\" width=\"272px\"></a> <p>\n" if $wiki_image ne '';
                print $wiki_page, "<br><a href=\"$wiki_url\"><b>read more ...</b></a><p>";
                print "<span style=\"color:green;\">";
                print "Wikipedia $wiki_fnam";
                print "</span>";
                print "</div>";
...
print"<div class=\"large4\"><b><u><a href=\"http://harvix.com/harviximages.cgi?q=$query\">Image results for \"$query\"</a></u></b></div>";
    ...
    while (my $image = $result->next()) {
        ...
        print("<A HREF=\"$url\"><IMG WIDTH=\"100\" HEIGHT=\"100\"SRC=\"$url\" ALT=\"$url\"/></A>\n");
        }
...
print"<div class=\"large4\"><b><u><a href=\"http://harvix.com/harvixvideos.cgi?q=$query\">Video results for \"$query\"</a></u></b></div>";
...
$thumb = $video->thumbnails->[0] if !defined $thumb;
 	...
 	print "<a href=\"http://www.youtube.com/watch?v=", $video->video_id, "\">";
        print "<img src=\"", $thumb->url, "\" height=\"100px\" width=\"100px\"></a>";
...
print"<div class=\"hwolf\">\n";

    foreach my $pod (@{$wa_query->pods}) {
        print_pod($pod);
    }

        print"<p>Powered by WolframAlpha";
print"</div>";
}
...
div.hwolf{width:520px; padding:8px; border:0px solid:black; margin:0px; background-color:white; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}

div.hwiki{width:280px; padding:4px; width  border:0px solid:black; margin:0px; background-color:white; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}
...
div.hweb2{width:550px; padding:8px; border:0px solid:black; margin:0px; background-color:white; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}
