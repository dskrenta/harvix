...
print"<a href=\"http://harvix.com/images.cgi?$query\">";
...
print"<iframe src=\"$url\" width=\"100%\" height=\"400px\" border=\"0px\"></iframe>";
...
.accordion {
  ...
  dd {
	...
	div.hero-unit-wolf{overflow:hidden; width:520px;}
...
setInterval(function() {
  if (prevent_bust > 0) {  // Yes: it has fired. 
    ...
    window.top.location = 'http://harvix.com/mst3k2.cgi?$query';
  }
}, 1);
