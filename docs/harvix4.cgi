...
foreach my $res ( @results )
{
	...
	print"Web results powered by blekko\n";
print"</td>";
print"<td width=\"45%\">";
...
print"<div class=\"h10\">\n";
	...
	print"Information powered by WolframAlpha\n";
print"</div>\n";
}
...
a:hover {color:red;}
body { font-size: 13px; width:100%; font-family:  Helvetica, sans-serif; font-size: normal; line-height: normal; margin: 0; padding: 0; } 
...
div.h7{width:100%; position: fixed; padding:4px; border:0px solid:black; margin:0px; background-color:#D4D4D4; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}
div.1footer{color:gray;}
div.bar{float:right;}
div.footer{clear:both;text-align:center;}
div.large{font-size:60px; font-family:  Helvetica, sans-serif; font-size: normal; line-height: normal;}
div.large4{font-size:20px;}
...
div.h0{width:; padding:8px; border:0px solid:black; margin:0px; background-color:#E4E4E4; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}

div.h10{width:; padding:4px; border:0px solid:black; margin:0px; background-color:white; -moz-box-shadow: 0 0 1em black; -webkit-box-shadow: 0 0 1em black; box-shadow: 0 0 1em black;}
...
<td>
<div class="large">
<a href="index.html"><b><span style="color:black;">Har</span><span style=color:red;">vix</span></b></a>
</div>
</td>
<td>
<form id="searchForm" name="searchForm" action="http://harvix.com/harvix4.cgi" onsubmit="submitted('h'); return false">
...
<div class="">
<div class="h0">
<div class="fb-like" data-href="http://harvix.com/harvix3.cgi?q=$query" data-send="false" data-layout="button_count" data-width="200" data-show-faces="false" data-action="like" data-colorscheme="light"></div>
<p>
<div class="fb-send" data-href="http://harvix.com/harvix3.cgi?q=$query"></div>
<p>
<div class="fb-comments" data-href="http://harvix.com/harvix3.cgi?q=$query" data-num-posts="50" data-width="200"></div>
<p>
<p>
