...
function preload() {
    var assets = {
        spritesheet: {
            birdie: ['http://harvix.com/flappy/birdie.png', 24, 24],
            clouds: ['http://harvix.com/flappy/clouds.png', 128, 64]
        },
        image: {
            finger: ['http://harvix.com/flappy/finger.png'],
            fence: ['http://harvix.com/flappy/fence.png']
        },
        audio: {
            flap: ['http://harvix.com/flappy/flap.wav'],
            score: ['http://harvix.com/flappy/score.wav'],
            hurt: ['http://harvix.com/flappy/hurt.wav']
        }
    };
