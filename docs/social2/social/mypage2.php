      ...
      <div class="container">
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <a class="brand" href=""><?php echo $_SESSION['myfullname']; ?></a>
            <!-- Responsive Navbar Part 2: Place all navbar contents you want collapsed withing .navbar-collapse.collapse. -->
            <div class="nav-collapse collapse">
              <ul class="nav">
                <li class="active"><a href="http://harvix.com/social2/social/mypage2.php">Home</a></li>
                <li><a href="http://harvix.com/social2/social/dashboard.php">Dashboard</a></li>
                <li><a href="http://harvix.com/social2/social/friends.php">Friends</a></li>
		<li><a href="http://harvix.com/social2/social/login_success2.php">Search</a></li>
                <!-- Read about Bootstrap dropdowns at http://twbs.github.com/bootstrap/javascript.html#dropdowns -->
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['myfullname']; ?> <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                  	<li><a href="http://harvix.com/social2/social/mypage2.php"><?php echo $_SESSION['myfullname']; ?></a></li>
                        <li><a href="http://harvix.com/social2/social/logout.php">Sign Out</a></li>
                        <li><a href="http://harvix.com/social2/social/settings.php">Settings</a></li>
	          </ul>
                </li>
              </ul>
            </div><!--/.nav-collapse -->
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          <img class="carousel-img" src="<?php echo $_SESSION['mycphoto']; ?>" alt="">
          <div class="container">
	     <div class="carousel-caption">
		<img class="img-polaroid" width="100px" src="<?php echo $_SESSION['mypphoto']; ?>"/>
		<h1><?php echo $_SESSION['myfullname']; ?></h1>
	        <p class="lead"><?php echo $_SESSION['myaboutme']; ?></p>
            </div>
          </div>
        </div>
      </div>
