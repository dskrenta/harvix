...
print"<p>$wiki_page</p>";
print"<p>$wiki_url</p>";
print"<a href=\"#myModalwiki\" class=\"btn btn-primary btn-large\" data-toggle=\"modal\">Read More &raquo;</a>";
print" 
...
<iframe src=\"$wiki_url\" width=\"100%\" height=\"85%\" frameborder=\"0\"></iframe>
...
<script>(function(d, s, id) {
  ...
  <input type="text" style="width:650px;" action="http://harvix.com/harvixreturn2.cgi" onsubmit="submitted('h'); return false" name="q"  class="search-query" placeholder="Showing results for $query">
