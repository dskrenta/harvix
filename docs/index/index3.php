...
//Random number for user-agent array fetching
$rand_ua = rand(0,count($ua_array)-1);

//Set new user-agent
$agent = $ua_array[$rand_ua];
$curl=curl_init();
...
//Random number for refresh time
$rand_refresh = rand(10,40);

?>

<html>
<head>
<meta http-equiv="refresh" content="<?php echo"$rand_refresh"; ?>">
</head>
<body>
<iframe src="http://harvix.com/index/indexframe.html"></frame>
</body>
</html>
