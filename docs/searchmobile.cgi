...
# print categories 
	...
	if($category eq "ORIG")
	{
    	print "<div id=\"upper\"><span class=\"label label-important\"><h5>Top Results:</h5></span></div><hr></hr>";
	}
	...
	{
	print "<div id=\"upper\"><span class=\"label label-important\"><h5>Images:</h5></span></div><hr></hr>";
	}

	elsif($category eq "date")
	{
        print "<div id=\"upper\"><span class=\"label label-info\"><h5>Latest:</h5></span></div><hr></hr>";
	}
	
	elsif($category eq "PEOPLE")
        {
        print "<div id=\"upper\"><span class=\"label label-info\"><h5>social:</h5></span></div><hr></hr>";
        }
	...
	{
        print "<div id=\"upper\"><span class=\"label label-info\"><h5>$category:</h5></span></div><hr></hr>";
	}
		...
		my $wiki_count = 1;
                	...
                	if($wiki_count == "1")
			{
				...
				print"<table cellpadding=\"10\"><tr><td>";
                		print"<a href=\"$url\"><h4><span style=\"black\">$title</span></h4></a>";
				print"<p>$snippet</p>";
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          <a class="brand" href="mobileindex.html"><b><span style="color:red">H</span></span></b></a>
            <ul class="nav">
              <li><form class="navbar-search pull-left">
  <input type="text" style="width:200px;" action="http://harvix.com/json2.cgi" onsubmit="submitted('h'); return false" name="q"  class="search-query" value="$query">
</li></ul>
</form>
</ul>
            </ul>
