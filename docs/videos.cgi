...
<a style=\"color:black\" href=\"http://www.youtube.com/watch?v="$id"\ target="_blank"><h3>$title-$id</h3></a>
<p>$des</p>
</td></tr></table>
</div>
";
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>$query | Harvix Images</title>
...
<script>(function(d, s, id) {
  ...
  <input type="text" style="width:650px;" action="http://howlix.com/videos.cgi" onsubmit="submitted('h'); return false" name="q"  class="search-query" placeholder="Showing results for $query">
