...
while ( my $r = $res->next ) {
	...
	print"<table cellspacing=\"8\" cellpadding=\"5\" width=\"100%\"><tr><td td valign=top>";
...
if ( $wiki )
        {
            my ( $wiki_best, $wiki_rank, $wiki_fnam, $wiki_title, $wiki_page, $wiki_image, $wiki_url ) = @$wiki;
                ...
                print "<p>";
                print"<table cellspacing=\"5\" cellpadding=\"5\"><tr><td valign=top>";
...
<p>
<div class="fb-comments" data-href="http://harvix.com/test.cgi?q=$query" data-num-posts="10" data-width="175"></div>
<p>
</td>
<td valign=top>
...
<tr><td>
<form id="searchform" name="searchForm" action="http://harvix.com/harvix.cgi" onsubmit="submitted('s'); return false;">
